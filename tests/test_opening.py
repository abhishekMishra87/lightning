...
def test_queryrates(node_factory, brocoind):
    ...
    assert result['our_funding_mbro'] == Millibronee(amount * 1000)
    assert result['their_funding_mbro'] == Millibronee(amount * 1000)
    assert result['funding_weight'] == 1000
    assert result['lease_fee_base_mbro'] == Millibronee(2000)
    assert result['lease_fee_basis'] == 140
    assert result['channel_fee_max_base_mbro'] == Millibronee(3000)
...
def test_v2_rbf_liquidity_ad(node_factory, brocoind, chainparams):
    ...
    assert Millibronee(0) == Millibronee(fundings['remote_mbro'])
...
def test_funder_options(node_factory, brocoind):
    ...
    assert funder_opts['min_their_funding_mbro'] == Millibronee('10000000mbro')
    assert funder_opts['max_their_funding_mbro'] == Millibronee('4294967295000mbro')
    assert funder_opts['per_channel_min_mbro'] == Millibronee('10000000mbro')
    assert funder_opts['per_channel_max_mbro'] == Millibronee('4294967295000mbro')
    assert funder_opts['reserve_tank_mbro'] == Millibronee('0mbro')
    ...
    assert chan_info['funding']['remote_mbro'] == Millibronee('0mbro')
    assert chan_info['funding']['local_mbro'] != Millibronee('0mbro')
    ...
    assert funder_opts['min_their_funding_mbro'] == Millibronee('100000mbro')
    assert funder_opts['max_their_funding_mbro'] == Millibronee('2000000000mbro')
    assert funder_opts['per_channel_min_mbro'] == Millibronee('8000000mbro')
    assert funder_opts['per_channel_max_mbro'] == Millibronee('10000000000mbro')
    assert funder_opts['reserve_tank_mbro'] == Millibronee('3000000mbro')
    assert funder_opts['fuzz_percent'] == 0
    ...
    assert chan_info['funding']['remote_mbro'] == Millibronee('9994255000mbro')
    assert chan_info['funding']['local_mbro'] == Millibronee('1000000000mbro')
