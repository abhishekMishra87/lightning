 ...
 * @funding_bros: The commitment transaction amount.
 * @local_mbro: The amount for the local side (remainder goes to remote)
 ...
 * @channel: The channel state
 * @feerate: The feerate in bronee per 1000 bytes.
 */
 ...
 * @channel: The channel
 * @feerate_per_kw: fee in bronee per 1000 bytes.
 *
