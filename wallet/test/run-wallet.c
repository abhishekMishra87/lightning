...
/* Generated stub for brocoind_getutxout_ */
void brocoind_getutxout_(struct brocoind *brocoind UNNEEDED,
			 const struct brocoin_outpoint *outpoint UNNEEDED,
			 void (*cb)(struct brocoind *brocoind UNNEEDED,
				    const struct brocoin_tx_output *txout UNNEEDED,
				    void *arg) UNNEEDED,
			 void *arg UNNEEDED)
{ fprintf(stderr, "brocoind_getutxout_ called!\n"); abort(); }
...
void broadcast_tx(struct chain_topology *topo UNNEEDED,
		  struct channel *channel UNNEEDED, const struct brocoin_tx *tx UNNEEDED,
...
bool channel_tell_depth(struct lightningd *ld UNNEEDED,
				 ...
				 const struct brocoin_txid *txid UNNEEDED,
				 u32 depth UNNEEDED)
...
void channel_update_reserve(struct channel *channel UNNEEDED,
			    ...
			    struct amount_bro funding_total UNNEEDED)
...
bool fromwire_channeld_got_commitsig(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *commitnum UNNEEDED, struct fee_states **fee_states UNNEEDED, struct height_states **blockheight_states UNNEEDED, struct brocoin_signature *signature UNNEEDED, struct brocoin_signature **htlc_signature UNNEEDED, struct added_htlc **added UNNEEDED, struct fulfilled_htlc **fulfilled UNNEEDED, struct failed_htlc ***failed UNNEEDED, struct changed_htlc **changed UNNEEDED, struct brocoin_tx **tx UNNEEDED)
{ fprintf(stderr, "fromwire_channeld_got_commitsig called!\n"); abort(); }
/* Generated stub for fromwire_channeld_got_revoke */
bool fromwire_channeld_got_revoke(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *revokenum UNNEEDED, struct secret *per_commitment_secret UNNEEDED, struct pubkey *next_per_commit_point UNNEEDED, struct fee_states **fee_states UNNEEDED, struct height_states **blockheight_states UNNEEDED, struct changed_htlc **changed UNNEEDED, struct penalty_base **pbase UNNEEDED, struct brocoin_tx **penalty_tx UNNEEDED)
...
bool fromwire_channeld_sending_commitsig(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, u64 *commitnum UNNEEDED, struct penalty_base **pbase UNNEEDED, struct fee_states **fee_states UNNEEDED, struct height_states **blockheight_states UNNEEDED, struct changed_htlc **changed UNNEEDED, struct brocoin_signature *commit_sig UNNEEDED, struct brocoin_signature **htlc_sigs UNNEEDED)
...
bool fromwire_hsmd_sign_commitment_tx_reply(const void *p UNNEEDED, struct brocoin_signature *sig UNNEEDED)
...
bool htlc_is_trimmed(enum side htlc_owner UNNEEDED,
		     struct amount_mbro htlc_amount UNNEEDED,
		     u32 feerate_per_kw UNNEEDED,
		     struct amount_bro dust_limit UNNEEDED,
...
void htlc_set_add(struct lightningd *ld UNNEEDED,
		  ...
		  struct amount_mbro total_mbro UNNEEDED,
...
bool invoices_create(struct invoices *invoices UNNEEDED,
		     ...
		     const struct amount_mbro *mbro TAKES UNNEEDED,
...
bool invoices_resolve(struct invoices *invoices UNNEEDED,
		      struct invoice invoice UNNEEDED,
		      struct amount_mbro received UNNEEDED)
...
/* Generated stub for json_add_amount_mbro_compat */
void json_add_amount_mbro_compat(struct json_stream *result UNNEEDED,
				 struct amount_mbro mbro UNNEEDED,
				 const char *rawfieldname UNNEEDED,
				 const char *mbrofieldname)

{ fprintf(stderr, "json_add_amount_mbro_compat called!\n"); abort(); }
/* Generated stub for json_add_amount_mbro_only */
void json_add_amount_mbro_only(struct json_stream *result UNNEEDED,
			  const char *mbrofieldname UNNEEDED,
			  struct amount_mbro mbro)

{ fprintf(stderr, "json_add_amount_mbro_only called!\n"); abort(); }
/* Generated stub for json_add_amount_bro_compat */
void json_add_amount_bro_compat(struct json_stream *result UNNEEDED,
				struct amount_bro bro UNNEEDED,
				const char *rawfieldname UNNEEDED,
				const char *mbrofieldname)

{ fprintf(stderr, "json_add_amount_bro_compat called!\n"); abort(); }
/* Generated stub for json_add_amount_bro_only */
void json_add_amount_bro_only(struct json_stream *result UNNEEDED,
			 const char *mbrofieldname UNNEEDED,
			 struct amount_bro bro)

{ fprintf(stderr, "json_add_amount_bro_only called!\n"); abort(); }
...
void json_add_tx(struct json_stream *result UNNEEDED,
		 const char *fieldname UNNEEDED,
		 const struct brocoin_tx *tx UNNEEDED)
...
struct chain_coin_mvt *new_coin_wallet_deposit(const tal_t *ctx UNNEEDED,
					       ...
					       struct amount_bro amount UNNEEDED,
					       enum mvt_tag tag)
...
void notify_forward_event(struct lightningd *ld UNNEEDED,
			  ...
			  /* May be NULL. */
			  const struct amount_mbro *amount_out UNNEEDED,
...
/* Generated stub for param_mbro */
struct command_result *param_mbro(struct command *cmd UNNEEDED, const char *name UNNEEDED,
				  const char *buffer UNNEEDED, const jsmntok_t *tok UNNEEDED,
				  struct amount_mbro **mbro UNNEEDED)
{ fprintf(stderr, "param_mbro called!\n"); abort(); }
...
u8 *towire_channeld_config_channel(const tal_t *ctx UNNEEDED, u32 *feerate_base UNNEEDED, u32 *feerate_ppm UNNEEDED, struct amount_mbro *htlc_minimum UNNEEDED, struct amount_mbro *htlc_maximum UNNEEDED)
...
u8 *towire_channeld_offer_htlc(const tal_t *ctx UNNEEDED, struct amount_mbro amount_mbro UNNEEDED, u32 cltv_expiry UNNEEDED, const struct sha256 *payment_hash UNNEEDED, const u8 onion_routing_packet[1366] UNNEEDED, const struct pubkey *blinding UNNEEDED)
...
u8 *towire_fee_insufficient(const tal_t *ctx UNNEEDED, struct amount_mbro htlc_mbro UNNEEDED, const u8 *channel_update UNNEEDED)
...
u8 *towire_final_incorrect_htlc_amount(const tal_t *ctx UNNEEDED, struct amount_mbro incoming_htlc_amt UNNEEDED)
...
u8 *towire_hsmd_sign_commitment_tx(const tal_t *ctx UNNEEDED, const struct node_id *peer_id UNNEEDED, u64 channel_dbid UNNEEDED, const struct brocoin_tx *tx UNNEEDED, const struct pubkey *remote_funding_key UNNEEDED, u64 commit_num UNNEEDED)
...
u8 *towire_incorrect_or_unknown_payment_details(const tal_t *ctx UNNEEDED, struct amount_mbro htlc_mbro UNNEEDED, u32 height UNNEEDED)
...
struct txwatch *watch_txid(const tal_t *ctx UNNEEDED,
			   ...
			   enum watch_result (*cb)(struct lightningd *ld UNNEEDED,
						   struct channel *channel UNNEEDED,
						   const struct brocoin_txid * UNNEEDED,
						   const struct brocoin_tx * UNNEEDED,
						   unsigned int depth))
...
static bool brocoin_tx_eq(const struct brocoin_tx *tx1,
			  const struct brocoin_tx *tx2)
{
	u8 *lin1, *lin2;
	bool eq;
				...
				struct channel_inflight *i2)
{
	...
	CHECK(amount_bro_eq(i1->funding->total_funds,
			    i2->funding->total_funds));
	CHECK(amount_bro_eq(i1->funding->our_funds, i2->funding->our_funds));
	CHECK(memeq(&i1->last_sig, sizeof(i1->last_sig),
		    &i2->last_sig, sizeof(i2->last_sig)));
	CHECK(brocoin_tx_eq(i1->last_tx, i2->last_tx));
	...
	CHECK(i1->lease_chan_max_mbro == i2->lease_chan_max_mbro);
...
static bool channelseq(struct channel *c1, struct channel *c2)
{
	...
	CHECK(amount_mbro_eq(c1->our_mbro, c2->our_mbro));
	...
	CHECK(brocoin_outpoint_eq(&c1->funding, &c2->funding));
	...
	if (c1->last_tx) {
		CHECK(brocoin_tx_eq(c1->last_tx, c2->last_tx));
	}
	...
	CHECK(c1->lease_chan_max_mbro == c2->lease_chan_max_mbro);
...
static bool test_channel_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	struct brocoin_txid *hash = tal(w, struct brocoin_txid);
	struct pubkey pk;
	struct node_id id;
	...
	secp256k1_ecdsa_signature *brocoin_sig1 = tal(w, secp256k1_ecdsa_signature);
	secp256k1_ecdsa_signature *node_sig2, *brocoin_sig2;
	...
	mempat(brocoin_sig1, sizeof(*brocoin_sig1));
	...
	c1.last_tx = brocoin_tx_from_hex(w, "", strlen(""));
	c1.last_sig.s = *sig;
	c1.last_sig.sighash_type = SIGHASH_ALL;
	c1.last_tx->chainparams = chainparams_for_network("brocoin");
	c1.unsaved_dbid = 0;
	...
	CHECK_MSG(!wallet_err,
		  tal_fmt(w, "Insert into DB: %s", wallet_err));
	wallet_announcement_save(w, c1.dbid, node_sig1, brocoin_sig1);
	CHECK_MSG(!wallet_err,
		  tal_fmt(w, "Insert ann sigs into DB: %s", wallet_err));
	CHECK_MSG(load = wallet_remote_ann_sigs_load(w, w, c1.dbid, &node_sig2, &brocoin_sig2), tal_fmt(w, "Load ann sigs from DB"));
	CHECK_MSG(!wallet_err,
	...
	CHECK_MSG(!memcmp(brocoin_sig1, brocoin_sig2, sizeof(*node_sig1)), "Compare ann sigs loaded with saved (v5)");
...
static bool test_channel_inflight_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	struct amount_bro funding_bros, our_bros;
	struct node_id id;
	struct pubkey pk;
	struct wireaddr_internal addr;
	struct peer *p;
	...
	funding_bros = AMOUNT_BRO(4444444);
	our_bros = AMOUNT_BRO(3333333);
	...
	/* last_tx taken from BOLT #3 */
	last_tx = brocoin_tx_from_hex(w, "", strlen(""));
	...
	chan = new_channel(p, wallet_get_channel_dbid(w),
			   ...
			   101, 1, 1, 1,
			   &outpoint,
			   funding_bros, AMOUNT_MBRO(0),
			   our_bros,
			   0, false,
			   &cid,
			   AMOUNT_MBRO(3333333000),
			   AMOUNT_MBRO(33333),
			   AMOUNT_MBRO(3333333333),
			   last_tx, &sig,
			   NULL,
			   channel_info,
	...
	funding_bros = AMOUNT_BRO(222222);
	our_bros = AMOUNT_BRO(111111);
	memset(&outpoint, 1, sizeof(outpoint));
	mempat(&sig.s, sizeof(sig.s));
	...
	funding_bros = AMOUNT_BRO(666666);
	our_bros = AMOUNT_BRO(555555);
...
static bool test_channel_config_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	cc1->dust_limit.bronees = 1;
	cc1->max_htlc_value_in_flight.millibronees = 2;
	cc1->channel_reserve.bronees = 3;
	cc1->htlc_minimum.millibronees = 4;
	cc1->to_self_delay = 5;
...
static bool test_htlc_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	in.key.id = 42;
	in.key.channel = chan;
	in.mbro = AMOUNT_MBRO(42);

	out.in = &in;
	out.key.id = 1337;
	out.key.channel = chan;
	out.mbro = AMOUNT_MBRO(41);
...
static bool test_payment_crud(struct lightningd *ld, const tal_t *ctx)
{
	...
	t->id = 0;
	t->mbronee = AMOUNT_MBRO(100);
	t->mbronee_sent = AMOUNT_MBRO(101);
	t->total_mbro = t->mbronee;
	...
	CHECK(amount_mbro_eq(t2->mbronee, t->mbronee));
	CHECK(amount_mbro_eq(t2->mbronee_sent, t->mbronee_sent));
	CHECK(amount_mbro_eq(t2->total_mbro, t->total_mbro));
