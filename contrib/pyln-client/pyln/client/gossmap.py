...
class GossmapHalfchannel(object):
    ...
    def __init__(self, channel: 'GossmapChannel', direction: int,
                 ...
                 htlc_minimum_mbro: int, htlc_maximum_mbro: int,
                 fee_base_mbro: int, fee_proportional_millionths: int):
        ...
        self.htlc_minimum_mbro: int = htlc_minimum_mbro
        self.htlc_maximum_mbro: Optional[int] = htlc_maximum_mbro
        self.fee_base_mbro: int = fee_base_mbro
...
class GossmapChannel(object):
    ...
    def _update_channel(self,
        ...
        half = GossmapHalfchannel(self, direction,
                                  ...
                                  fields['htlc_minimum_mbro'],
                                  fields.get('htlc_maximum_mbro', None),
                                  fields['fee_base_mbro'],
...
class Gossmap(object):
    ...
    def _set_channel_amount(self, rec: bytes):
        ...
        bros, = struct.unpack(">Q", rec[2:])
        self.channels[self._last_scid].bronees = bros
