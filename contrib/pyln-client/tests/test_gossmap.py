...
def test_gossmap(tmp_path):
    ...
    assert g.get_channel("686386x1093x1") is None
    assert channel2.bronees == 3000000
...
def test_gossmap_halfchannel(tmp_path):
    ...
    assert half0.htlc_minimum_mbro == 0
    assert half1.htlc_minimum_mbro == 0
    assert half0.htlc_maximum_mbro == 990000000
    assert half1.htlc_maximum_mbro == 990000000
    assert half0.fee_base_mbro == 1
    assert half1.fee_base_mbro == 1
