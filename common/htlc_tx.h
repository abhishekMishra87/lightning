...
static inline struct amount_bro htlc_timeout_fee(u32 feerate_per_kw,
...
static inline struct amount_bro htlc_success_fee(u32 feerate_per_kw,
						 bool option_anchor_outputs)
{
	/* BOLT #3:
	 *
...
struct brocoin_tx *htlc_success_tx(const tal_t *ctx,
				   ...
				   struct amount_mbro htlc_mbronee,
				   u16 to_self_delay,
				   u32 feerate_per_kw,
...
void htlc_success_tx_add_witness(struct brocoin_tx *htlc_success,
				 ...
				 const struct brocoin_signature *localsig,
