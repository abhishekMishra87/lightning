...
{
	struct amount_bro htlc_fee, htlc_min;
	...
	if (!amount_bro_add(&htlc_min, dust_limit, htlc_fee))
		return true;
	return amount_mbro_less_bro(htlc_amount, htlc_min);
}
...
u32 htlc_trim_feerate_ceiling(u32 feerate_per_kw)
{
	 ...
	 * of either 2530 bros per kWU or 125% of the
