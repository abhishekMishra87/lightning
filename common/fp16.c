...
bool amount_mbro_less_fp16(struct amount_mbro amt, fp16_t fp)
{
	return amt.millibronees < fp16_to_u64(fp); /* Raw: fp16 compare */
}

bool amount_mbro_greater_fp16(struct amount_mbro amt, fp16_t fp)
{
	return amt.millibronees > fp16_to_u64(fp); /* Raw: fp16 compare */
}
