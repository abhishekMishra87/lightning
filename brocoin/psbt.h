#ifndef LIGHTNING_BROCOIN_PSBT_H
#define LIGHTNING_BROCOIN_PSBT_H
#include "config.h"
 ...
 * between inputs - outputs. Unlike brocoin, elements requires every
 * bronee to be accounted for in an output.
 */
...
#endif /* LIGHTNING_BROCOIN_PSBT_H */
