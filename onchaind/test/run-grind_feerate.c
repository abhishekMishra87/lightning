...
bool fromwire_hsmd_sign_tx_reply(const void *p UNNEEDED, struct brocoin_signature *sig UNNEEDED)
...
struct brocoin_tx *htlc_timeout_tx(const tal_t *ctx UNNEEDED,
				   const struct chainparams *chainparams UNNEEDED,
				   const struct brocoin_outpoint *commit UNNEEDED,
				   const u8 *commit_wscript UNNEEDED,
				   struct amount_mbro htlc_mbronee UNNEEDED,
...
int main(int argc, char *argv[])
{
	...
	tx = brocoin_tx_from_hex(tmpctx, "0200000001e1ebca08cf1c301ac563580a1126d5c8fcb0e5e2043230b852c726553caf1e1d0000000000000000000160ae0a000000000022002082e03c5a9cb79c82cd5a0572dc175290bc044609aabe9cc852d61927436041796d000000",
	...
	psbt_input_set_wit_utxo(tx->psbt, 0, spk, AMOUNT_BRO(700000));
	tx->chainparams = chainparams_for_network("brocoin");
	...
	assert(amount_bro_eq(fee, AMOUNT_BRO(165750)));
