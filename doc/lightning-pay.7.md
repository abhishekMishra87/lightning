...
**pay** *bolt11* [*mbronee*] [*label*] [*riskfactor*]
...
contain an amount, *mbronee* is required, otherwise if it is specified
it must be *null*. *mbronee* is in millibronee precision; it can be a
whole number, or a whole number with suffix *mbro* or *bro*, or a three
decimal point number with suffix *bro*, or an 1 to 11 decimal point
number suffixed by *bron*.
...
`exemptfee` (default: 5000 millibronee).
...
- **amount_mbro** (mbro): Amount the recipient received
- **amount_sent_mbro** (mbro): Total amount we sent (including fees)
...
[comment]: # ( SHA256STAMP:f78aa762c837c29e55de78ac8493436c8463391c52ca15eb6120092144429c6c)
