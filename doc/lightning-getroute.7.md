...
**getroute** *id* *mbronee* *riskfactor* [*cltv*] [*fromid*]
...
payment of *mbronee* to lightning node *id*, such that the payment will
arrive at *id* with *cltv*-blocks to spare (default 9).

*mbronee* is in millibronee precision; it can be a whole number, or a
...
Here are the risk fees in millibronees, using various parameters. I
assume a channel charges the default of 1000 millibronees plus 1
...
difference between the first *mbronee* minus the *mbronee* given in
