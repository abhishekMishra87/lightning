...
- **amount_sent_mbro** (mbro): the amount we actually sent, including fees
- **created_at** (u64): the UNIX timestamp showing when this payment was initiated
- **partid** (u64, optional): unique ID within this (multi-part) payment
- **destination** (pubkey, optional): the final destination of the payment if known
- **amount_mbro** (mbro, optional): the amount the destination received, if known
   ...
   "payments": [
      {
         ...
         "mbronee": 1000,
         "amount_mbro": "1000mbro",
         "mbronee_sent": 1000,
         "amount_sent_mbro": "1000mbro",
...
[comment]: # ( SHA256STAMP:f65d601990221f42586625d0d974cc77f71ecf07b124ae2c3e1e8d85f59fb744)
