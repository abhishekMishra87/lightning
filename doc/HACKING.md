...
[lightningd.c](https://github.com/abhishekMishra87/lightning-network/blob/master/lightningd/lightningd.c) and hop your way through
...
* brocoin/ - brocoin script, signature and transaction routines.
...
You can run queries against this file like so:
    ...
    $ sqlite3 ~/.lightning/brocoin/lightningd.sqlite3 \
