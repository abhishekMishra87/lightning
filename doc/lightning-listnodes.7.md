...
If **option_will_fund** is present:
  - **option_will_fund** (object):
    - **lease_fee_base_mbro** (mbro): the fixed fee for a lease (whole number of bronees)
    ...
    - **channel_fee_max_base_mbro** (mbro): the maximum base routing fee this node will charge during the lease
...
[comment]: # ( SHA256STAMP:01c53e1e4da8069ba0638615b13ddb1a7598a68d9868bfcf844b04bf61c632a1)
