...
If **type** is "bolt12 offer", and **valid** is *true*:
  ...
  - **chains** (array of hexs, optional): which blockchains this offer is for (missing implies brocoin mainnet only):
    - the genesis blockhash (always 64 characters)
  - **currency** (string, optional): ISO 4217 code of the currency (missing implies Brocoin) (always 3 characters)
  ...
  - **amount_mbro** (mbro, optional): the amount in brocoin (if specified, and no *currency*)
...
If **type** is "bolt12 invoice", and **valid** is *true*:
  ...
  - **amount_mbro** (mbro): the amount in brocoin
  - **description** (string): the description of the purpose of the offer
  ...
  - **chain** (hex, optional): which blockchain this invoice is for (missing implies brocoin mainnet only) (always 64 characters)
...
If **type** is "bolt12 invoice", and **valid** is *false*:
  ...
  - the following warnings are possible:
    - **warning_invoice_missing_amount**: **amount_mbro* missing
...
If **type** is "bolt12 invoice_request", and **valid** is *true*:
  ...
  - **chain** (hex, optional): which blockchain this invoice_request is for (missing implies brocoin mainnet only) (always 64 characters)
  - **amount_mbro** (mbro, optional): the amount in brocoin
  - **features** (hex, optional): the array of feature bits for this offer
  - **quantity** (u64, optional): the quantity ordered
  - **recurrence_counter** (u32, optional): the 0-based counter for a recurring payment
  - **recurrence_start** (u32, optional): the optional start period for a recurring payment
...
If **type** is "bolt11 invoice", and **valid** is *true*:
  ...
  - **amount_mbro** (mbro, optional): Amount the invoice asked for
  ...
  - **routes** (array of arrays, optional): Route hints to the *payee*:
    - hops in the route:
      ...
      - **fee_base_mbro** (u32): the base fee for payments
...
[comment]: # ( SHA256STAMP:69ad2d23d3d22f37ca2f232ffc6d5b4432f0af3a5d08ce7890f3c1f15f2bb4de)
