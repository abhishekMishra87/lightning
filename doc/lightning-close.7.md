...
The *destination* can be of any Brocoin bech32 type.
...
can be an integer in which case it is interpreted as number of bronees
...
proposes a closing fee of 3000 bronee and our estimate shows it must be 4000:
...
If **type** is "mutual" or "unilateral":
  - **tx** (hex): the raw brocoin transaction used to close the channel (if it was open)
...
[comment]: # ( SHA256STAMP:dd733a621f875dc81deadbb9bf7cf8d3242f0cf5499a387335d497085fcf9add)
