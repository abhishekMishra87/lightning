...
* *perkw* - provide feerate in units of bronees per 1000 weight.
* *perkb* - provide feerate in units of bronees per 1000 virtual bytes.

Brocoin transactions have non-witness and witness bytes:
...
- **onchain_fee_estimates** (object, optional):
  - **opening_channel_bronees** (u64): Estimated cost of typical channel open
  - **mutual_close_bronees** (u64): Estimated cost of typical channel close
  - **unilateral_close_bronees** (u64): Estimated cost of typical unilateral close (without HTLCs)
  - **htlc_timeout_bronees** (u64): Estimated cost of typical HTLC timeout transaction
  - **htlc_success_bronees** (u64): Estimated cost of typical HTLC fulfillment transaction
...
[comment]: # ( SHA256STAMP:b4b9d3ca14537a9f3a26298f5219525912d4b2c4e879a33645afe5f070bf823d)
