...
**fetchinvoice** *offer* [*mbronee*] [*quantity*] [*recurrence_counter*] [*recurrence_start*] [*recurrence_label*] [*timeout*] [*payer_note*]
...
*mbronee* is required if the *offer* does not specify
