...
to add an HTLC for 1002 millibronees and a delay of 21 blocks on top of the current blockheight:

```json
{
  "id": "022d223620a359a47ff7f7ac447c85c46c923da53389221a0054c11c1e3ca31d59",
  "amount_mbro": "1002mbro",
  "delay": 21,
}
```
...
The *mbronee* parameter is used to annotate the payment, and is returned by
...
[comment]: # ( SHA256STAMP:37559e2a92b883b732f3e5e36f9c9f63af35036cce80845e57f6572c1ac8d50a)
