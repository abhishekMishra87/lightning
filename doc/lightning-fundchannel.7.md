...
[*utxos*] [*push_mbro*] [*close_to*] [*request_amt*] [*compact_lease*]
...
*amount* is the amount in bronees taken from the internal wallet to
fund the channel. The string *all* can be used to specify all available
funds (or 16777215 bronee if more is available and large channels were not negotiated with the peer). Otherwise, it is in
...
decimal places ending in *bron*. The value cannot be less than the dust
limit, currently set to 546, nor more than 16777215 bronee (unless large
