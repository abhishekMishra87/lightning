...
- **amount_mbro** (mbro): the total capacity of this channel (always a whole number of bronees)
...
- **base_fee_millibronee** (u32): Base fee changed by *source* to use this channel
...
- **htlc_minimum_mbro** (mbro): The smallest payment *source* will allow via this channel
- **features** (hex): BOLT #9 features bitmap for this channel
- **htlc_maximum_mbro** (mbro, optional): The largest payment *source* will allow via this channel
...
[comment]: # ( SHA256STAMP:e529536d55d095cd115ddfc7e7964a21b5861f65cf94d4e4cc1de7c7f762d324)
