...
**sendpay** *route* *payment\_hash* [*label*] [*mbronee*]
...
The *mbronee* amount must be provided if *partid* is non-zero, otherwise
it must be equal to the final
amount to the destination. By default it is in millibronee precision; it can be a whole number, or a whole number
...
*payment\_hash* but a different *mbronee* or destination will fail;
this prevents accidental multiple payments. Calls to **sendpay** with
the same *payment\_hash*, *mbronee*, and destination as a previous
...
[comment]: # ( SHA256STAMP:8188cb75f1e719312117e3f61dd09248a403125d74709f47e0036d69d0749021)
