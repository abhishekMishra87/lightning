...
pub mod requests {
	...
	pub struct SendpayRequest {
	    ...
	    #[serde(alias = "mbronee", skip_serializing_if = "Option::is_none")]
	    pub mbronee: Option<Amount>,
	...
	pub struct SendonionFirst_hop {
	    #[serde(alias = "id")]
	    pub id: Pubkey,
	    #[serde(alias = "amount_mbro")]
	    pub amount_mbro: Amount,
	    #[serde(alias = "delay")]
	    pub delay: u16,
	}
	...
	pub struct WithdrawRequest {
	    ...
	    #[serde(alias = "bronee", skip_serializing_if = "Option::is_none")]
	    pub bronee: Option<AmountOrAll>,
...
pub mod responses {
	...
	pub struct GetinfoResponse {
	    ...
	    #[serde(alias = "network")]
	    pub network: String,
	    #[serde(alias = "fees_collected_mbro")]
	    pub fees_collected_mbro: Amount,
	    #[serde(alias = "address", skip_serializing_if = "Option::is_none")]
	    ...
	    pub warning_brocoind_sync: Option<String>,
	...
	pub struct ListpeersPeersChannelsInflight {
	    ...
	    #[serde(alias = "feerate")]
	    pub feerate: String,
	    #[serde(alias = "total_funding_mbro")]
	    pub total_funding_mbro: Amount,
	    #[serde(alias = "our_funding_mbro")]
	    pub our_funding_mbro: Amount,
	...
	pub struct ListpeersPeersChannelsFunding {
	    #[serde(alias = "local_mbro")]
	    pub local_mbro: Amount,
	    #[serde(alias = "remote_mbro")]
	    pub remote_mbro: Amount,
	    #[serde(alias = "pushed_mbro")]
	    pub pushed_mbro: Amount,
	}
	...
	pub struct ListpeersPeersChannels {
	    ...
	    #[serde(alias = "to_us_mbro", skip_serializing_if = "Option::is_none")]
	    pub to_us_mbro: Option<Amount>,
	    #[serde(alias = "min_to_us_mbro", skip_serializing_if = "Option::is_none")]
	    pub min_to_us_mbro: Option<Amount>,
	    #[serde(alias = "max_to_us_mbro", skip_serializing_if = "Option::is_none")]
	    pub max_to_us_mbro: Option<Amount>,
	    #[serde(alias = "total_mbro", skip_serializing_if = "Option::is_none")]
	    pub total_mbro: Option<Amount>,
	    #[serde(alias = "fee_base_mbro", skip_serializing_if = "Option::is_none")]
	    pub fee_base_mbro: Option<Amount>,
	    #[serde(alias = "fee_proportional_millionths", skip_serializing_if = "Option::is_none")]
	    pub fee_proportional_millionths: Option<u32>,
	    #[serde(alias = "dust_limit_mbro", skip_serializing_if = "Option::is_none")]
	    pub dust_limit_mbro: Option<Amount>,
	    #[serde(alias = "max_total_htlc_in_mbro", skip_serializing_if = "Option::is_none")]
	    pub max_total_htlc_in_mbro: Option<Amount>,
	    #[serde(alias = "their_reserve_mbro", skip_serializing_if = "Option::is_none")]
	    pub their_reserve_mbro: Option<Amount>,
	    #[serde(alias = "our_reserve_mbro", skip_serializing_if = "Option::is_none")]
	    pub our_reserve_mbro: Option<Amount>,
	    #[serde(alias = "spendable_mbro", skip_serializing_if = "Option::is_none")]
	    pub spendable_mbro: Option<Amount>,
	    #[serde(alias = "receivable_mbro", skip_serializing_if = "Option::is_none")]
	    pub receivable_mbro: Option<Amount>,
	    #[serde(alias = "minimum_htlc_in_mbro", skip_serializing_if = "Option::is_none")]
	    pub minimum_htlc_in_mbro: Option<Amount>,
	    #[serde(alias = "minimum_htlc_out_mbro", skip_serializing_if = "Option::is_none")]
	    pub minimum_htlc_out_mbro: Option<Amount>,
	    #[serde(alias = "maximum_htlc_out_mbro", skip_serializing_if = "Option::is_none")]
	    pub maximum_htlc_out_mbro: Option<Amount>,
	    ...
	    #[serde(alias = "in_offered_mbro", skip_serializing_if = "Option::is_none")]
	    pub in_offered_mbro: Option<Amount>,
	    #[serde(alias = "in_payments_fulfilled", skip_serializing_if = "Option::is_none")]
	    pub in_payments_fulfilled: Option<u64>,
	    #[serde(alias = "in_fulfilled_mbro", skip_serializing_if = "Option::is_none")]
	    pub in_fulfilled_mbro: Option<Amount>,
	    #[serde(alias = "out_payments_offered", skip_serializing_if = "Option::is_none")]
	    pub out_payments_offered: Option<u64>,
	    #[serde(alias = "out_offered_mbro", skip_serializing_if = "Option::is_none")]
	    pub out_offered_mbro: Option<Amount>,
	    #[serde(alias = "out_payments_fulfilled", skip_serializing_if = "Option::is_none")]
	    pub out_payments_fulfilled: Option<u64>,
	    #[serde(alias = "out_fulfilled_mbro", skip_serializing_if = "Option::is_none")]
	    pub out_fulfilled_mbro: Option<Amount>,
	...
	pub struct ListfundsChannels {
	    #[serde(alias = "peer_id")]
	    pub peer_id: Pubkey,
	    #[serde(alias = "our_amount_mbro")]
	    pub our_amount_mbro: Amount,
	    #[serde(alias = "amount_mbro")]
	    pub amount_mbro: Amount,
	    #[serde(alias = "funding_txid")]
	    pub funding_txid: String,
	...
	pub struct SendpayResponse {
	    ...
	    #[serde(alias = "amount_mbro", skip_serializing_if = "Option::is_none")]
	    pub amount_mbro: Option<Amount>,
	    #[serde(alias = "destination", skip_serializing_if = "Option::is_none")]
	    pub destination: Option<Pubkey>,
	    #[serde(alias = "created_at")]
	    pub created_at: u64,
	    #[serde(alias = "amount_sent_mbro")]
	    pub amount_sent_mbro: Amount,
	    #[serde(alias = "label", skip_serializing_if = "Option::is_none")]
	    pub label: Option<String>,
	    #[serde(alias = "partid", skip_serializing_if = "Option::is_none")]
	    pub partid: Option<u64>,
	...
	pub struct ListchannelsChannels {
	    ...
	    pub last_update: u32,
	    #[serde(alias = "base_fee_millibronee")]
	    pub base_fee_millibronee: u32,
	    #[serde(alias = "fee_per_millionth")]
	    pub fee_per_millionth: u32,
	    #[serde(alias = "delay")]
	    pub delay: u32,
	    #[serde(alias = "htlc_minimum_mbro")]
	    pub htlc_minimum_mbro: Amount,
	    #[serde(alias = "htlc_maximum_mbro", skip_serializing_if = "Option::is_none")]
	    pub htlc_maximum_mbro: Option<Amount>,
	    #[serde(alias = "features")]
	    pub features: String,
	}
	...
	pub struct CreateinvoiceResponse {
	    ...
	    #[serde(alias = "amount_received_mbro", skip_serializing_if = "Option::is_none")]
	    pub amount_received_mbro: Option<Amount>,
	...
	pub struct FundpsbtResponse {
	    ...
	    #[serde(alias = "excess_mbro")]
	    pub excess_mbro: Amount,
	...
	pub struct FeeratesOnchain_fee_estimates {
	    #[serde(alias = "opening_channel_bronees")]
	    pub opening_channel_bronees: u64,
	    #[serde(alias = "mutual_close_bronees")]
	    pub mutual_close_bronees: u64,
	    #[serde(alias = "unilateral_close_bronees")]
	    pub unilateral_close_bronees: u64,
	    #[serde(alias = "htlc_timeout_bronees")]
	    pub htlc_timeout_bronees: u64,
	    #[serde(alias = "htlc_success_bronees")]
	    pub htlc_success_bronees: u64,
	}
	...
	pub struct ListforwardsForwards {
	    ...
	    #[serde(alias = "fee_mbro", skip_serializing_if = "Option::is_none")]
	    pub fee_mbro: Option<Amount>,
	    #[serde(alias = "out_mbro", skip_serializing_if = "Option::is_none")]
	    pub out_mbro: Option<Amount>,
	}
	...
	pub struct ListpaysPays {
	    ...
	    #[serde(alias = "amount_mbro", skip_serializing_if = "Option::is_none")]
	    pub amount_mbro: Option<Amount>,
	    #[serde(alias = "amount_sent_mbro", skip_serializing_if = "Option::is_none")]
	    pub amount_sent_mbro: Option<Amount>,
	    #[serde(alias = "erroronion", skip_serializing_if = "Option::is_none")]
	    pub erroronion: Option<String>,
	}
